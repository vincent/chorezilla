...
export type ChoresRecord = {
	...
	last_completed_by?: RecordIdString;
	last_notified_push?: IsoDateString;
	name: string;
	room: RecordIdString;
...
export type HouseholdMembersResponse<Texpand = unknown> = Required<HouseholdMembersRecord> &
	BaseSystemFields<Texpand>;
export type HouseholdsResponse<Texpand = unknown> = Required<HouseholdsRecord> &
	BaseSystemFields<Texpand>;
export type InvitationsResponse<Texpand = unknown> = Required<InvitationsRecord> &
	BaseSystemFields<Texpand>;
export type RoomsResponse<Texpand = unknown> = Required<RoomsRecord> & BaseSystemFields<Texpand>;
export type UserSubscriptionsResponse<Tsubscription = unknown, Texpand = unknown> = Required<
	UserSubscriptionsRecord<Tsubscription>
> &
	BaseSystemFields<Texpand>;
