...
>
	...
	<g>
		...
		/>
		<rect x="242.601" y="434.718" fill="currentColor" width="26.802" height="77.282" />
		<rect x="242.601" fill="currentColor" width="26.802" height="77.33" />
		<polygon
			fill="currentColor"
		...
		/>
		<rect x="434.69" y="242.638" fill="currentColor" width="77.297" height="26.774" />
		<rect x="0.013" y="242.638" fill="currentColor" width="77.28" height="26.774" />
		<polygon
			fill="currentColor"
