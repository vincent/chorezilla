...
<![CDATA[
	...
	<g>
		<path
			fill="currentColor"
			d="M444.969,118.656c-18.016-18.359-42.063-28.844-67.703-29.531l-8.672-0.234l-1.828-8.469
		...
		<polygon
			fill="currentColor"
			points="287.469,196.25 133.672,372.25 176.156,374.844 117.5,512 331.047,299.781 250.078,299.781 	"
		/>
	</g>
</svg>
