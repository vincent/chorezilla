...
<![CDATA[
	...
	<g>
		<path
			fill="currentColor"
			d="M490.462,316.323c-0.5-0.5-1.328-1.203-2.469-2.141c4.297-17.672,6.563-36.141,6.563-55.109
		...
		<path
			fill="currentColor"
			d="M273.258,379.588c-11.578,23.734-28.938,53.704-51.656,79.235c-6.016,6.766-5.406,17.109,1.344,23.109
