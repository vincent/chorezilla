	...
	<div class="container mx-auto px-4">
		<div class="flex justify-around py-3">
			...
			<a
				...
				aria-label="Rooms"
				class="p-2 text-gray-500"
				class:text-indigo-600={active === '/rooms'}
			>
				<House class="w-6 h-6" />
			</a>
			{#if $isAdmin}
				<a
					...
					class="p-2 pt-[20px] bg-indigo-600 text-white rounded-full -mt-6 shadow-lg p-4"
				>
			...
			<a
				...
				aria-label="People"
				class="p-2 text-gray-500"
				class:text-indigo-600={active === '/members'}
			>
				<Users class="w-6 h-6" />
			</a>
			<a
				...
				aria-label="Settings"
				class="p-2 text-gray-500"
				class:text-indigo-600={active === '/settings'}
			>
